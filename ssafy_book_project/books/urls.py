...
urlpatterns = [
    ...
    path("<int:book_pk>/create/", views.create_thread, name='create_thread'),
    ...
    path("<int:book_pk>/threads/<int:thread_pk>/comments/update", views.update_comment, name='update_comment'),
    path("<int:book_pk>/threads/<int:thread_pk>/comments/delete", views.delete_comment, name='delete_comment'),
